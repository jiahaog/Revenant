...
Revenant.prototype = {
    ...
    getUrl: function (callback) {
        ...
        return promiseOrCallback(callback, function (resolve, reject) {
            ...
            // get the current url
            if (self.page) {
                getData.getCurrentUrl(self.page, self.phantom, function (error, page, ph, url) {
                    if (error) {
                        reject(error);
                        return;
                    }
    ...
    downloadFromUrl: function (selector, callback) {
        return this.__pushTask(getData.downloadFromUrl, selector, callback);
    },

    downloadFromClick: function (url, callback) {
        return this.__pushTask(getData.downloadFromClick, url, callback);
    },
