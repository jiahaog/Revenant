...
Revenant.prototype = {
     ...
     * @param {boolean} expectAjax if true, checks for dom changes before callback,
     *                             else checks if the page has navigated to another page (new url)
     * @param callback
     */
    clickElement: function (selector, expectAjax, callback) {
        return this.__pushTask(base.clickElement, [selector, expectAjax], callback);
    },
