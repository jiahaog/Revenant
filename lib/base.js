...
// levenshtein difference threshold while checking if two DOM is similiar
...
/**
 * Uses levenshtein distance to check if two DOM strings are different
 * @param oldDom
 * @param newDom
 * @returns {boolean}
 */
function domIsDifferent(oldDom, newDom) {
    var checker = new Levenshtein(oldDom, newDom);
    var distance = checker.distance;
