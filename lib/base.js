    ...
    async.waterfall([
        ...
        function (callback) {
            page.evaluate(clickSelector, function (error) {
                ...
                ajaxCallback(page, ph, oldUrl, options, callback);
...
/**
 * Performs .click() simply on a html element
 * This does not work on some html elements, use clickElement unless necessary
 * @param page
 * @param ph
 * @param {array} selectorAndOptions Index 0 - {string} selector CSS Selector
 *                                    Index 1 - {int} options
 ...
 * @param {pageCallback} callback
 */
function clickElementSimply(page, ph, selectorAndOptions, callback) {

    var selector = selectorAndOptions[0];
    var options = selectorAndOptions[1];

    function simpleClickFn(selector) {
        try {
            var element = document.querySelector(selector);
            element.click();
            return null;
    ...
    async.waterfall([
        ...
        function (callback) {
            page.evaluate(simpleClickFn, function (error) {
...
module.exports = {
    ...
    clickElementSimply: clickElementSimply,
